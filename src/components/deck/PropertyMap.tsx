...
/**
 * Stylized schematic of MOA's property — a four-anchor cross plan around
 * Nickelodeon Universe at center. Each region is clickable and routes to its
 * chapter. This is a hand-built honest schematic; when an Imagen-generated
 * isometric is traced into SVG, this can be swapped 1-for-1.
 */
...
export type MapAnchor = {
  ...
  chapterId: string;
  /** Position in viewBox (0-100 each axis). */
  cx: number;
  cy: number;
  width: number;
  height: number;
...
const ANCHORS: MapAnchor[] = [
  ...
  // North wing — Cultural / events Rotunda
  {
    id: "north",
  ...
  // West wing — Luxury (the quiet wing)
  {
    id: "west",
    label: "Luxury",
    chapterId: "luxury",
...
type Props = {
  ...
  /** chapterId → chapter index for routing. */
